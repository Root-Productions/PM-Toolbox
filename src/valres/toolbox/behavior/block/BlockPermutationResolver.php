...
final class BlockPermutationResolver {
    public static function applyDefault(BlockBuilder $builder): void {
        ...
        self::applyAgePermutations($builder);
    }

    private static function applyAgePermutations(BlockBuilder $builder): void {
        ...
        if ($block instanceof Crops) {
            ...
            foreach ($ages as $age) {
                ...
                $permutation->addComponent(new SelectionBoxComponent(
                    new BlockBox([-8.0, 0.0, -8.0], [16.0, (($age + 1.0) * (1 / $block::MAX_AGE)) * 0.7 * 16, 16.0])
                ));
