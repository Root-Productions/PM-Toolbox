...
use valres\toolbox\behavior\item\vanilla\VanillaBlockItemRegistration;
...
final class CustomBlockRegistry {
    ...
    private function registerBlockItem(BlockBuilder $builder): void {
        ...
        $itemBuilder = VanillaBlockItemRegistration::createBuilder($builder, $item);
    ...
    private function registerCustomBlockItem(ItemBuilder $builder, ?BlockBuilder $blockBuilder = null): void {
        ...
        if ($blockBuilder !== null) {
            VanillaBlockItemRegistration::applyComponents($builder, $blockBuilder);
        }
